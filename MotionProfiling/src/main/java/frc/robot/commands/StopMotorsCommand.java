...
public class StopMotorsCommand extends CommandBase {
  ...
  /**
   * Creates a new StopMotorsCommand.
   */
  public StopMotorsCommand(Subsystem driveSubsystem) {
  ...
  public void initialize() {
    //driveSubsystem.tankFeedForward(-Constants.maxVelocity, -Constants.maxVelocity, 0.0);
  }
